        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8">
              Ready to reduce shipping damage and increase sustainability? Our team is here to help.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@ecoshield.com" className="text-eco-green hover:text-eco-green-dark transition-colors">
                      info@ecoshield.com
                    </a>
                    ...
                    <a href="mailto:sales@ecoshield.com" className="text-eco-green hover:text-eco-green-dark transition-colors block mt-2">
                      sales@ecoshield.com
                    </a>
                    <p className="text-gray-600 mt-1 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+11234567890" className="text-eco-green hover:text-eco-green-dark transition-colors">
                      +1 (123) 456-7890
                    </a>
                    <p className="text-gray-600 mt-1 text-sm">
                      Mon-Fri, 9AM-5PM EST
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-eco-green/10 p-3 rounded-lg text-eco-green hover:bg-eco-green hover:text-white transition-colors">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-eco-green focus:border-transparent"
                      >
                        <option value="less-1000">Less than 1,000 packages</option>
                        <option value="1000-5000">1,000 - 5,000 packages</option>
                        <option value="5000-10000">5,000 - 10,000 packages</option>
                        <option value="10000-plus">More than 10,000 packages</option>
                      </select>
                    </div>
